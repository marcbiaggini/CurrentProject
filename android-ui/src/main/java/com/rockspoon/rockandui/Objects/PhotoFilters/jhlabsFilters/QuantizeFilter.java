...
import com.rockspoon.rockandui.Objects.PhotoFilters.JhlabsFilters.Interfaces.Quantizer;
import com.rockspoon.rockandui.Objects.PhotoFilters.JhlabsFilters.Support.OctTreeQuantizer;
              ...
              for (int j = -1; j <= 1; j++) {
                ...
                if (0 <= jx && jx < width) {
                  ...
                  if (w != 0) {
                    ...
                    g1 += eg * w / sum;
                    b1 += eb * w / sum;
                    inPixels[k] = (PixelUtil.clamp(r1) << 16) | (PixelUtil.clamp(g1) << 8) | PixelUtil.clamp(b1);
                  }
                }
              }
            }
