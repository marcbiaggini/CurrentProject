...
public abstract class Filter {
  ...
  protected Bitmap createRadialGradient() {
    RadialGradient gradient = new RadialGradient(width / 2, height / 2, width / 2, Color.GRAY, 0xFF000000, android.graphics.Shader.TileMode.CLAMP);
  ...
  public Bitmap setSepiaColorFilter(Bitmap image) {
    ...
    float[] sepMat = {0.3930000066757202f, 0.7689999938011169f, 0.1889999955892563f, 0, 0, 0.3490000069141388f, 0.6859999895095825f, 0.1679999977350235f, 0, 0, 0.2720000147819519f, 0.5339999794960022f, 0.1309999972581863f, 0, 0, 0, 0, 0, 0.5f, 0, 0, 0, 0, 0, 0.5f};
  ...
  protected Bitmap combineGradientAndImage(Bitmap gradient, Bitmap image, PorterDuff.Mode mode) {
    Bitmap result = image.copy(Bitmap.Config.ARGB_8888, true);
  ...
  public abstract Bitmap transform(Bitmap image);
}
