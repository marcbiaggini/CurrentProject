...
import com.rockspoon.rockandui.Objects.PhotoFilters.JhlabsFilters.Support.Kernel;
...
public class GaussianFilter extends ConvolveFilter {
   ...
   */
  public static void convolveAndTranspose(Kernel kernel, int[] inPixels, int[] outPixels, int width,
                                          int height, boolean alpha, boolean premultiply,
    ...
    for (int y = 0; y < height; y++) {
      ...
      for (int x = 0; x < width; x++) {
        ...
        int ia = alpha ? PixelUtil.clamp((int) (a + 0.5)) : 0xff;
        int ir = PixelUtil.clamp((int) (r + 0.5));
        int ig = PixelUtil.clamp((int) (g + 0.5));
        int ib = PixelUtil.clamp((int) (b + 0.5));
